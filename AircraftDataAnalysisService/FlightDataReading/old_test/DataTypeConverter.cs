...
namespace FlightDataReading.old_test
{
    public class DataTypeConverter
    {
        ...
        //public static MongoDB.Bson.BsonValue ToBsonType(string valueText, PropertyDescriptor desc)
        //{
        //    if (desc != null)
        //    {
        //        if (desc.DataTypeStr == DATETIME)
        //        {
        //            if (desc is DateTimePropertyDescriptor)
        //            {
        //                return (desc as DateTimePropertyDescriptor).ToBsonType(valueText);
        //            }
        //            return new MongoDB.Bson.BsonDateTime(DateTime.Parse(valueText));
        //        }
        //        else if (desc.DataTypeStr == INT32)
        //            return new MongoDB.Bson.BsonInt32(Int32.Parse(valueText));
        //        else
        //            return new MongoDB.Bson.BsonString(valueText);
        //    }
