using AircraftDataAnalysisWinRT.Data;
...
namespace AircraftDataAnalysisWinRT
{
    ...
    /// 显示分组的项集合的页。
    /// </summary>
    public sealed partial class GroupedItemsPage : AircraftDataAnalysisWinRT.Common.LayoutAwarePage
    {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            var aircraftDataGroups = AircraftMongoDbDataSource.GetGroups(navigationParameter.ToString());
            this.DefaultViewModel["Groups"] = aircraftDataGroups;
        }
