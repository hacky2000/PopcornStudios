...
namespace Gecko.Search
{
	public static class BrowserSearchService
	{
        ...
        {
            return ExtensionMethods.Wrap(nsString.Pass<nsISearchEngine>(_browserSearchService.Instance.GetEngineByAlias, alias),
                x => new SearchEngine(x));
            //return nsString.Pass<nsISearchEngine>( _browserSearchService.Instance.GetEngineByAlias, alias )
            //               .Wrap( x => new SearchEngine( x ) );
		}
        ...
        {
            return ExtensionMethods.Wrap(nsString.Pass<nsISearchEngine>(_browserSearchService.Instance.GetEngineByName, engineName),
                x => new SearchEngine(x));
            //return nsString.Pass<nsISearchEngine>(_browserSearchService.Instance.GetEngineByName, engineName)
            //    .Wrap(x => new SearchEngine(x));
		}
		...
		public static SearchEngine DefaultEngine
		{
			get
            {
                return ExtensionMethods.Wrap(_browserSearchService.Instance.GetDefaultEngineAttribute(),
                     x => new SearchEngine(x));
                //return _browserSearchService.Instance.GetDefaultEngineAttribute()
                //                            .Wrap( x => new SearchEngine( x ) );
			}
		}
		...
		public static SearchEngine CurrentEngine
		{
			get
            {
                return ExtensionMethods.Wrap(_browserSearchService.Instance.GetCurrentEngineAttribute(),
                     x => new SearchEngine(x));
                //return _browserSearchService.Instance.GetCurrentEngineAttribute()
                //                            .Wrap( x => new SearchEngine( x ) );
			}
			set { _browserSearchService.Instance.SetCurrentEngineAttribute( value._searchEngine.Instance ); }
		}
		...
		public static SearchEngine OriginalDefaultEngine
		{
			get
            {
                return ExtensionMethods.Wrap(_browserSearchService.Instance.GetOriginalDefaultEngineAttribute(),
                     x => new SearchEngine(x));
                //return _browserSearchService.Instance.GetOriginalDefaultEngineAttribute()
                //                            .Wrap( x => new SearchEngine( x ) );
			}
		}
	}
