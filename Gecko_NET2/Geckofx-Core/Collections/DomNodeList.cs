...
namespace Gecko.Collections
{
        ...
        where TGeckoNode : class, nsIDOMNode
    {
        ...
        internal DomNodeList(nsIDOMNodeList list, BaseTypes.Func<TGeckoNode, TWrapper> translator)
        {
            _list = list;
        ...
        public TWrapper this[int index]
        {
            get
            {
                ...
                {
                    return ExtensionMethods.Wrap((TGeckoNode)item,
                         _translator);
        ...
        where TGeckoNode : class, nsIDOMNode
    {
        ...
        public DomHtmlCollection(nsIDOMHTMLCollection collection, BaseTypes.Func<TGeckoNode, TWrapper> translator)
        {
