...
namespace Gecko.Collections
{
	...
	{
		private readonly BaseTypes.Func<TGeckoObject, TWrapper> _translator;
		private readonly BaseTypes.Func<nsISimpleEnumerator> _enumeratorCreator;
		...
		public GeckoEnumerableCollection(BaseTypes.Func<nsISimpleEnumerator> enumeratorCreator, BaseTypes.Func<TGeckoObject, TWrapper> translator)
		{
	...
	internal sealed class SimpleGeckoEnumerableCollection<T>
		:IEnumerable<T>
	{
		private BaseTypes.Func<IEnumerator<T>> _enumeratorCreator;

		public SimpleGeckoEnumerableCollection(BaseTypes.Func<IEnumerator<T>> enumeratorCreator)
		{
			_enumeratorCreator = enumeratorCreator;
		}
