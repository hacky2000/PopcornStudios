...
namespace Gecko.Net
{
        ...
        : IDisposable
    {
        ...
        public LoadGroup LoadGroup
        {
            get
            {
                return ExtensionMethods.Wrap(_request.Instance.GetLoadGroupAttribute(), x => new LoadGroup(x));
                //return _request.Instance.GetLoadGroupAttribute().Wrap( x => new LoadGroup( x ) ); 
            }
