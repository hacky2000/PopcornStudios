...
namespace Gecko.Net
{
        ...
        : Channel
    {
        ...
        public Uri Referrer
        {
            ...
            get
            {
                return Xpcom.ToUri(_httpChannel.GetReferrerAttribute());
                //    return _httpChannel.GetReferrerAttribute().ToUri(); 
            }
            //TODO - check for memory leaks
        ...
        public void GetRequestHeaders<T>(T accumulator, BaseTypes.Action<T, string, string> func)
        {
        ...
        public void GetResponseHeaders<T>(T accumulator, BaseTypes.Action<T, string, string> func)
        {
            HttpHeaderVisitor visitor = new HttpHeaderVisitor((x, y) => func(accumulator, x, y));
            _httpChannel.VisitResponseHeaders(visitor);
        }
        ...
        public UploadChannel CastToUploadChannel()
        {
            ...
            return ExtensionMethods.Wrap(channel, x => new UploadChannel(x));
        ...
        {
            private BaseTypes.Action<string, string> _func;
            public HttpHeaderVisitor(BaseTypes.Action<string, string> func)
            {
                _func = func;
            }
