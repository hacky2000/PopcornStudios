...
namespace Gecko
{
	...
	public interface IGeckoWebBrowser
	{
		...
		/// <summary>
		/// Return the markup document viewer
		/// </summary>
		/// <returns></returns>
		GeckoMarkupDocumentViewer GetMarkupDocumentViewer();
        ...
        void UserInterfaceThreadInvoke(BaseTypes.Action action);
		/// <summary>
		/// UI platform independent call function from UI thread
		/// </summary>
		...
		/// <returns></returns>
		T UserInterfaceThreadInvoke<T>( BaseTypes.Func<T> func );
