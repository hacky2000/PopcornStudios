...
namespace Gecko
{
        ...
        : GeckoNode
    {
        ...
        public DOM.DomDocumentType Doctype
        {
            get
            {
                return ExtensionMethods.Wrap(_domDocument.GetDoctypeAttribute(),
                      DomDocumentType.Create);
                //return _domDocument.GetDoctypeAttribute().Wrap(DomDocumentType.Create); 
            }
        }
        ...
        public GeckoElement DocumentElement
        {
            get
            {
                ...
                return ExtensionMethods.Wrap(domElement,
                      GeckoElement.CreateDomElementWrapper);
        ...
        public GeckoElement CreateElement(string tagName)
        {
            ...
            return ExtensionMethods.Wrap(nsString.Pass<nsIDOMElement>(_domDocument.CreateElement, tagName),
                  GeckoElement.CreateDomElementWrapper);
        ...
        {
            return ExtensionMethods.Wrap(_domDocument.CreateDocumentFragment(),
                  DocumentFragment.CreateDocumentFragmentWrapper);
        ...
        {
            return ExtensionMethods.Wrap(nsString.Pass<nsIDOMText>(_domDocument.CreateTextNode, data),
                  DOM.GeckoTextNode.CreateTextNodeWrapper);
        ...
        {
            return ExtensionMethods.Wrap(nsString.Pass<nsIDOMComment>(_domDocument.CreateComment, data),
                  GeckoComment.CreateCommentWrapper);
        ...
        public GeckoAttribute CreateAttribute(string name)
        {
            ...
            return ExtensionMethods.Wrap(nsString.Pass<nsIDOMAttr>(_domDocument.CreateAttribute, name),
        ...
        /// <returns></returns>
        public IGeckoArray<GeckoHtmlElement> GetElementsByTagName(string tagName)
        {
            if (string.IsNullOrEmpty(tagName))
                return null;

            return ExtensionMethods.Wrap(nsString.Pass<nsIDOMNodeList>(_domDocument.GetElementsByTagName, tagName),
                  x => new DomNodeList<GeckoHtmlElement, nsIDOMHTMLElement>(x, GeckoHtmlElement.Create));
            //return nsString.Pass<nsIDOMNodeList>(_domDocument.GetElementsByTagName, tagName)
            //                .Wrap(x => new DomNodeList<GeckoHtmlElement, nsIDOMHTMLElement>(x, GeckoHtmlElement.Create));
        }
        ...
        public GeckoAttribute CreateAttribute(string namespaceUri, string qualifiedName)
        {
            ...
            return ExtensionMethods.Wrap(nsString.Pass<nsIDOMAttr>(_domDocument.CreateAttributeNS, namespaceUri, qualifiedName),
                  GeckoAttribute.CreateAttributeWrapper);
        ...
        public DomEventArgs CreateEvent(string name)
        {
            ...
            return ExtensionMethods.Wrap(target,
                  DomEventArgs.Create);
        ...
        /// </summary>
        /// <returns></returns>
        public IGeckoArray<GeckoElement> GetElementsByTagNameNS(string namespaceUri, string localName)
        {
            if (string.IsNullOrEmpty(namespaceUri))
                throw new ArgumentException("namespaceUri");
            ...
            return ExtensionMethods.Wrap(nsString.Pass<nsIDOMNodeList>(_domDocument.GetElementsByTagNameNS, namespaceUri, localName),
                x => new DomNodeList<GeckoElement, nsIDOMElement>(x, GeckoElement.CreateDomElementWrapper));
            //return nsString.Pass<nsIDOMNodeList>(_domDocument.GetElementsByTagNameNS, namespaceUri, localName)
        ...
        public GeckoElement GetElementById(string id)
        {
            ...
            return ExtensionMethods.Wrap(nsString.Pass<nsIDOMElement>(_domDocument.GetElementById, id),
                GeckoElement.CreateDomElementWrapper);
        ...
        public GeckoHtmlElement GetHtmlElementById(string id)
        {
            ...
            return (GeckoHtmlElement)ExtensionMethods.Wrap(nsString.Pass<nsIDOMElement>(_domDocument.GetElementById, id),
                Create);
        ...
        public GeckoWindow DefaultView
        {
            get
            {
                return ExtensionMethods.Wrap(_domDocument.GetDefaultViewAttribute(),
                      GeckoWindow.Create);
                //return _domDocument.GetDefaultViewAttribute().Wrap(GeckoWindow.Create);
            }
        }
        ...
        public Location Location
        {
            get
            {
                return ExtensionMethods.Wrap(_domDocument.GetLocationAttribute(),
                      Location.Create);
                //return _domDocument.GetLocationAttribute().Wrap(Location.Create);
            }
        }
        ...
        public GeckoHtmlElement ActiveElement
        {
            get
            {
                return (GeckoHtmlElement)ExtensionMethods.Wrap(_domDocument.GetActiveElementAttribute(),
                      Create);
                //return (GeckoHtmlElement)_domDocument.GetActiveElementAttribute().Wrap(Create);
            }
        }
        ...
        /// <returns></returns>
        public IGeckoArray<GeckoNode> GetElementsByClassName(string classes)
        {
            return ExtensionMethods.Wrap(nsString.Pass<nsIDOMNodeList>(_domDocument.GetElementsByClassName, classes),
                   x => new DomNodeList<GeckoNode, nsIDOMNode>(x, Create));
            //return nsString.Pass<nsIDOMNodeList>( _domDocument.GetElementsByClassName, classes )
        ...
        public GeckoNode CurrentScript
        {
            get
            {
                return ExtensionMethods.Wrap(_domDocument.GetCurrentScriptAttribute(),
                      Create);
                //return _domDocument.GetCurrentScriptAttribute().Wrap(Create); 
            }
        }
