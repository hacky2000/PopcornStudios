...
namespace Gecko
{
        ...
        : IDisposable, IEquatable<GeckoNode>
    {
        ...
        public IGeckoArray<GeckoNode> ChildNodes
        {
            get
            {
                return ExtensionMethods.Wrap(_domNode.Instance.GetChildNodesAttribute(),
        ...
        public GeckoNode FirstChild
        {
            get
            {
                return ExtensionMethods.Wrap(_domNode.Instance.GetFirstChildAttribute(), Create);
                //    return _domNode.Instance.GetFirstChildAttribute().Wrap(Create); 
            }
        }
        public GeckoNode LastChild
        {
            get
            {
                return ExtensionMethods.Wrap(_domNode.Instance.GetLastChildAttribute(), Create);
                //return _domNode.Instance.GetLastChildAttribute().Wrap(Create); 
            }
        }
        public GeckoNode NextSibling
        {
            get
            {
                return ExtensionMethods.Wrap(_domNode.Instance.GetNextSiblingAttribute(), Create);
                //return _domNode.Instance.GetNextSiblingAttribute().Wrap(Create); 
            }
        }
        public GeckoNode PreviousSibling
        {
            get
            {
                return ExtensionMethods.Wrap(_domNode.Instance.GetPreviousSiblingAttribute(), Create);
                // return _domNode.Instance.GetPreviousSiblingAttribute().Wrap(Create); 
            }
        }
        ...
        public GeckoDomDocument OwnerDocument
        {
            get
            {
                ...
                return ExtensionMethods.Wrap(nativeDoc, GeckoDomDocument.CreateDomDocumentWraper);
        ...
        public GeckoNamedNodeMap Attributes
        {
            get
            {
                return ExtensionMethods.Wrap(_domNode.Instance.GetAttributesAttribute(),
                    GeckoNamedNodeMap.Create);
                //    return _domNode.Instance.GetAttributesAttribute().Wrap(GeckoNamedNodeMap.Create);
            }
        }
        ...
        public GeckoNode ParentNode
        {
            get
            {
                return ExtensionMethods.Wrap(_domNode.Instance.GetParentNodeAttribute(),
                    Create);
                //return _domNode.Instance.GetParentNodeAttribute().Wrap(Create); 
            }
        }
        ...
        public GeckoElement ParentElement
        {
            get
            {
                ...
                return ExtensionMethods.Wrap(((nsIDOMElement)node),
        ...
        public GeckoNode GetSingleElement(string xpath)
        {
            ...
            {
                return ExtensionMethods.Wrap(result.IterateNext(),
                    Create);
                //return result.IterateNext().Wrap(Create);
            }

            return ExtensionMethods.Wrap(result.GetSingleNodeValueAttribute(),
                Create);
        ...
        public DomEventTarget GetEventTarget()
        {
            ...
            return ExtensionMethods.Wrap(eventTarget,
                DomEventTarget.Create);
