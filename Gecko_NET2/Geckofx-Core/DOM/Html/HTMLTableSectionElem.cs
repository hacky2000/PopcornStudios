...
namespace Gecko.DOM
{
    public class GeckoTableSectionElement : GeckoHtmlElement
    {
        ...
        internal GeckoTableSectionElement(nsIDOMHTMLTableSectionElement element)
            : base(element)
        {
            this.DOMHTMLElement = element;
        }
        public GeckoTableSectionElement(object element)
        ...
        public IGeckoArray<GeckoElement> Rows
        {
            get
            {
                return ExtensionMethods.Wrap(DOMHTMLElement.GetRowsAttribute(),
                     x => new DomHtmlCollection<GeckoElement, nsIDOMElement>(x, CreateDomElementWrapper));
