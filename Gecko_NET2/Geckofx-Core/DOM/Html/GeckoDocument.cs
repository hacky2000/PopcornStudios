...
namespace Gecko
{
    ...
    public class GeckoDocument : GeckoDomDocument
    {
        ...
        public IGeckoArray<GeckoHtmlElement> Forms
        {
            get
            {
                return ExtensionMethods.Wrap(_domHtmlDocument.GetFormsAttribute(),
                    x => new DomHtmlCollection<GeckoHtmlElement, nsIDOMHTMLElement>(
        ...
        public IGeckoArray<GeckoElement> Images
        {
            get
            {
                return ExtensionMethods.Wrap(_domHtmlDocument.GetImagesAttribute(),
        ...
        public IGeckoArray<GeckoElement> Anchors
        {
            get
            {
                return ExtensionMethods.Wrap(_domHtmlDocument.GetAnchorsAttribute(),
                    x => new DomHtmlCollection<GeckoElement, nsIDOMElement>(
                                       x, GeckoElement.CreateDomElementWrapper));
        ...
        public IGeckoArray<GeckoElement> Applets
        {
            get
            {
                return ExtensionMethods.Wrap(_domHtmlDocument.GetAppletsAttribute(),
                    x => new DomHtmlCollection<GeckoElement, nsIDOMElement>(
                                      x, GeckoElement.CreateDomElementWrapper));
        ...
        public IGeckoArray<GeckoElement> Links
        {
            get
            {
                return ExtensionMethods.Wrap(_domHtmlDocument.GetLinksAttribute(),
                    x => new DomHtmlCollection<GeckoElement, nsIDOMElement>(
                                       x, GeckoElement.CreateDomElementWrapper));
        ...
        public IGeckoArray<GeckoElement> GetElementsByName(string name)
        {
            ...
            return ExtensionMethods.Wrap(nsString.Pass(_domHtmlDocument.GetElementsByName, name),
