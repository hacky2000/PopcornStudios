...
namespace Gecko.DOM.Svg
{
        ...
        : GeckoDomDocument
    {
        ...
        public SvgSvgElement RootElement
        {
            get
            {
                return ExtensionMethods.Wrap(_svgDocument.GetRootElementAttribute(), SvgSvgElement.CreateSvgSvgElementWrapper);
                // return _svgDocument.GetRootElementAttribute().Wrap(SvgSvgElement.CreateSvgSvgElementWrapper);
            }
        }
