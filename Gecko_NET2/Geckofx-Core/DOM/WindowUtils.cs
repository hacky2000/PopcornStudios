...
namespace Gecko.DOM
{
    public class WindowUtils
    {
        ...
        {
            return ExtensionMethods.Wrap(_windowUtils.Instance.EnterModalStateWithWindow(),
                  GeckoWindow.Create);
        ...
        {
            return ExtensionMethods.Wrap(_windowUtils.Instance.GetOuterWindowWithId(aOuterWindowID),
                  GeckoWindow.Create);
