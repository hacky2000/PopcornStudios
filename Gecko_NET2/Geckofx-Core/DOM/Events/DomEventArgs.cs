...
namespace Gecko
{
        ...
        : EventArgs
    {
        ...
        public DOM.DomEventTarget CurrentTarget
        {
            get
            {
                return ExtensionMethods.Wrap(_event.GetCurrentTargetAttribute(),
                    DOM.DomEventTarget.Create);
                //    return _event.GetCurrentTargetAttribute().Wrap( DOM.DomEventTarget.Create ); 
            }
        }
        ...
        public DOM.DomEventTarget Target
        {
            get
            {
                return ExtensionMethods.Wrap(_event.GetTargetAttribute(),
                    DOM.DomEventTarget.Create); //return _event.GetTargetAttribute().Wrap( DOM.DomEventTarget.Create ); 
            }
        }
