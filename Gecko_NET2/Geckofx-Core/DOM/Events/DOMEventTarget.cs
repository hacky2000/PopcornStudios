...
namespace Gecko.DOM
{
    public sealed class DomEventTarget
    {
        ...
        public DomEventTarget TargetForDOMEvent
        {
            get
            {
                return ExtensionMethods.Wrap(_target.Instance.GetTargetForDOMEvent(),
                     Create);
                //return _target.Instance.GetTargetForDOMEvent().Wrap(Create);
            }
        }
        ...
        public DomEventTarget TargetForEventTargetChain
        {
            get
            {
                return ExtensionMethods.Wrap(_target.Instance.GetTargetForEventTargetChain(),
                     Create);
                //return _target.Instance.GetTargetForEventTargetChain().Wrap(Create); 
            }
        }
